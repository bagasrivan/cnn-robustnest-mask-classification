...
def build_resnet50_model():
    """Membangun arsitektur dasar model ResNet50"""
...
if __name__ == '__main__':
    ...
    for current_seed in SEEDS:
        print(f"\n========================================================")
        print(f"RUNNING RESNET50 EXPERIMENT - SEED {current_seed}")
        print(f"========================================================")
        
        set_system_seed(current_seed)
        train_gen, val_gen = load_data_generators(current_seed=current_seed)
        
        model_name = f'best_resnet50_seed_{current_seed}.keras'
    ...
    print("\n==========================================================")
    print("RESNET50 REPEATED RUNS SUMMARY REPORT")
    print("==========================================================")
